...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"996d9e40-715b-4241-86e8-e6d77673dfdd","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"element":"appTitle"}],"middle":[{"element":"leftPane"},{"element":"middlePane"},{"element":"rightPane"}],"right":[{"children":[{"element":"logout"}],"element":"user"},{"menuType":"float","element":"rightMenu"},{"menuType":"float","element":"navigationTabs"}]};
