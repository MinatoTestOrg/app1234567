...
inputText:any ='';
  ...
  "children" : [ {
    ...
    "confirmationText" : "do_you_want_to_perform_this_action?",
    "label" : "BACK",
    "type" : "button",
    "beforeAction" : "none",
    "outline" : false,
  ...
  "children" : [ {
    ...
    "allowEditing" : "yes",
    "fieldName" : "uniqueKeyValue",
    "data" : "",
    "field" : "uniqueKeyValue",
    "uiType" : "text",
    "name" : "uniqueKeyValue",
    "isPrimaryKey" : false,
    "label" : "UNIQUE_KEY_VALUE",
    "type" : "formField",
    "mandatory" : "no",
    "fieldType" : "string",
    "allowViewing" : "yes"
...
public location = inject(Location);
	...
	uniqueKeyValue: new UntypedFormControl('',[]),
});
...
this.backupData = this.appUtilBaseService.deepClone(this.detailFormControls.getRawValue());
	...
	getDateTimeFields() {
    return ['syncTime','createdDate','modifiedDate'];
  }
