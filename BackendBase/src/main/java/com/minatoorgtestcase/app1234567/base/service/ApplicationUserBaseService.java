package com.minatoorgtestcase.app1234567.base.service;
...
import com.minatoorgtestcase.app1234567.base.model.ApplicationUserBase;
import com.minatoorgtestcase.app1234567.base.service.IApplicationUserBaseService;
import com.minatoorgtestcase.app1234567.model.Roles;
...
public abstract class ApplicationUserBaseService<T extends ApplicationUserBase> extends BaseBusinessLogic<T> implements IApplicationUserBaseService<T>
{
	...
	public ApplicationUserBaseService(Class<T> modelClass) {
		...
		addPersistenceOption(AnalyticalOptions.GROUP_NAME, "9c80a8fa-2422-408a-8f90-a42294968008");
